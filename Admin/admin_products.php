...
if(isset($_POST['add_product'])){
   ...
   $genretype = mysqli_real_escape_string($conn, $_POST['genretype']);;
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, image, sellingtype, genretype, authorname) VALUES('$name', '$price', '$image', '$sellingtype', '$genretype', '$authorname')") or die('query failed');
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="sellingtype" class="box">
         <option>Select Selling Type</option>
         <option>Sell</option>
         <option>Donate</option>
      </select>
      <input type="text" name="genretype" class="box" placeholder="enter genre type" required>
